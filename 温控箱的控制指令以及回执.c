...
GET_MacValve_1_Status//得到继电器的状态			回执:RESP_MacValve_1_Value \RESP_MacValve_1_ERROR		// Value 為 ON / OFF,ERROR表示失败，请重新读取
...
GET_MFC_1_GAS//得到MFC的流量					回执:RESP_MFC_1_GAS_Value\RESP_MFC_1_GAS_ERROR			// Value 為數值,ERROR表示失败，请重新读取
GET_MFC_1_Status//得到MFC的状态					回执:RESP_MFC_1_Status_Value\RESP_MFC_1_Status_ERROR	// Value 為 ON / OFF,ERROR表示失败，请重新读取
